...
**CLI Tool:** sh
**Requirements:** `kubectl` should be already installed
...
- [@ardasendur](https://github.com/ardasendur)
- [@bilgehannal](https://github.com/bilgehannal)